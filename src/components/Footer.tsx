    ...
    <footer className="bg-[#111827] text-zinc-300 pt-16 pb-8 border-t border-zinc-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <Link to="/" className="flex flex-col items-start mb-5 group">
              <div className="flex items-end">
                <span className="text-[#D32F2F] font-black text-3xl tracking-tighter uppercase leading-none group-hover:text-red-400 transition-colors">
                  TRACKO
                </span>
                <span className="text-zinc-500 font-bold text-[10px] ml-1 mb-1">&reg;</span>
              </div>
              <span className="text-zinc-400 font-bold text-[10px] tracking-widest mt-1 uppercase">
                Engine Parts
              </span>
            </Link>
        ...
        <div className="border-t border-zinc-800 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-zinc-500">
          <p>Copyright &copy; 2025 Tracko Internationals. All Rights Reserved. ISO 9001:2015 Certified.</p>
